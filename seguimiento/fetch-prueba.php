...
$columns = array('nombre', 'agencia', 'departamento', 'puesto', 'anio' , 'cliente', 'agenciaCliente', 'interes','seguimiento', 'created_at');
...
//$sub_array[] = $row['mes'];
 ...
 $sub_array[] = '<button type="button" name="update" id="'.$row["id"].'" class="btn btn-primary btn-md update" style="margin-right:10px;"><i class="fas fa-user-edit"></i></button>';
