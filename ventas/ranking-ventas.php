...
$sql="SELECT * FROM ventas WHERE anio = '".$yearGet."' order by ventas DESC";
...
<head>
    ...
    <title>Top 10 "Ventas Todos Somos Comerciales VANGUARDIA"</title>
</head>
...
<section class="container p-3">
        <!--for demo wrap-->
        <h1>Top 10 "Ventas Todos Somos Comerciales de <?php echo $monthGet?> <?php echo $yearGet?>"</h1>
        ...
        <table class="table table-light">
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                <tr>
                    ...
                    <td data-label="# ventas" style="color:#1F61AE;"><i class="fas fa-heart"></i> <?php echo $row["ventas"];?></td>
                </tr>
                <?php
                    }
                }
