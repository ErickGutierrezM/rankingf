...
//$mes = '';
$query = "SELECT DISTINCT mes FROM ventas ORDER BY mes ASC";
...
<body>
  <!--  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h2 class="text-center p-1"><span class="badge badge-danger p-2"><i class="fas fa-heart"></i> Ventas</span><span class="badge badge-light p-2">Vanguardia</span></h2> 
    </div>
    ...
    $(document).ready(function() {
        ...
        function fetch_data(filter_gender = '', filter_country = '') {
