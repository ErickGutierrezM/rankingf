...
//$sql="SELECT * FROM usuarios WHERE mes = '".$monthGet."' AND anio = '".$yearGet."' order by referidos DESC";
...
<head>
    ...
    <title>Top 10 "Referidos Todos Comerciales VANGUARDIA"</title>
</head>
...
<section class="container p-3">
        <!--for demo wrap-->
        <h1>Top 10 "Referidos Todos Somos Comerciales VANGUARDIA de <?php echo $yearGet?>"</h1>
        ...
        <table class="table table-light">
            ...
            if(mysqli_num_rows($result) > 0)
            {
                ...
                <tr>
                    ...
                    <td data-label="Agencia"><?php echo $row["agencia"];?></td>
                    <td data-label="Departamento"><?php echo $row["departamento"];?></td>
                    <td data-label="Puesto"><?php echo $row["puesto"];?></td>
